...
- Не перезапускай `/swift-review`, `/skill-audit` и другие скиллы из их же отчётов.
- Один запуск скилла = один отчёт; повторный запуск только по явной новой команде пользователя.
