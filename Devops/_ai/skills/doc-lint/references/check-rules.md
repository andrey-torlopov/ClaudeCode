...
|--------------------|------------|-------------|
| Tech Stack, Safety, DevOps Conventions | `CLAUDE.md` | Всегда в контексте, минимум дублирования |
...
| **Reference** | таблицы параметров, API signatures, конфигурационные параметры, чисто факты без нарратива | API docs, config refs |
