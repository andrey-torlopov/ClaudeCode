...
<triggers>
  <activate_on>
    ...
    3. Обнаружен паттерн, отсутствующий в `devops-patterns/`
  </activate_on>

  <do_not_activate_on>
    Штатные validation fix, разовые опечатки, user preference изменения.
  </do_not_activate_on>
</triggers>
...
<routing>
  | Класс ошибки                          | Target                            |
  |---------------------------------------|-----------------------------------|
  | Повторяющийся паттерн в конфигах      | `devops-patterns/{name}.md`       |
