...
Используй этот шаблон только как короткий entry-файл. Все core rules и verify-команды должны жить в `COMMON.md`.
...
- Для повседневной работы используй `.ai/dev_agent.md`.
