...
|--------|-------------------|-----------|
| Инфраструктурные изменения, скрипты, CI/CD | Self или `agents/engineer.md` | Конфиги и скрипты |
...
- Если задача требует паттернов, сначала открой `.ai/patterns/_index.md`, а не весь каталог.
