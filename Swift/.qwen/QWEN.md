...
This file is the entry point for Qwen-compatible runtimes.

## Read Order

1. Read `./../COMMON.md` - this is the SSOT for rules and basic context.
2. Read `./../.ai/setup_context.md` - there is a map of the `./../.ai/` ​​layer.
3. Connect `./../.ai/dev_agent.md`, `_ai/agents/*.md`, `./../.ai/skills/*/SKILL.md` and `./../.ai/patterns/_index.md` only when necessary.
