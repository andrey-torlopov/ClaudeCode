...
---
name: init-project
description: Генерирует CLAUDE.md для Rust проекта на основе анализа репозитория. Используй для нового проекта без CLAUDE.md. Не используй если CLAUDE.md уже настроен.
