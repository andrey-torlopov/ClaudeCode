...
### Реальный пример: rust-review

```
_ai/skills/rust-review/
├── SKILL.md                    # ~250 строк - core логика
└── references/
    ├── rust-checklist.md       # Полный чек-лист проверок
    └── concurrency-rules.md    # Правила Rust concurrency
```
...
**Хорошо:**
```yaml
description: Анализирует Rust-код на unsafe usage, data races и нарушения conventions
description: Сканирует Rust-репозиторий и каталогизирует структуру, зависимости, архитектуру
description: Проверяет Cargo-зависимости на актуальность и конфликты
```
...
|-----------|---------|----------------|
| **Analysis** | /rust-review, /repo-scout | Отчет с findings |
