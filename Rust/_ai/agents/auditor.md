...
- `BLOCKER` — panic в production, unsound `unsafe`, data races, security, сильное расхождение с требованиями.
- `CRITICAL` — логические баги, blocking in async, broken flows, опасный API misuse.
