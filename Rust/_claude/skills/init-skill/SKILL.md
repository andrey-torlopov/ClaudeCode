...
Категории: **Analysis** (отчет), **Generation** (код/документ), **Validation** (pass/fail), **Transformation** (конвертация).
...
**ОБЯЗАТЕЛЬНО покажи файл и дождись выбора!**
...
**НЕ СОХРАНЯЙ без подтверждения пользователя!**
